...
<div class="content">
    ...
    <div class="container">
        ...
        <div style="border: 1px #EBEBEB solid; border-radius: 16px;">
            ...
            <form action="<?= BASEURL . 'product/editproduct_send' ?>" method="post" enctype="multipart/form-data">
                <div class="modal-content">
                    <div style="display: flex; flex-direction: column; gap: 24px;">
                        <label for="input-file" id="drop-area">
                            <img id="preview-image" src="<?= BASEURL . 'assets/products/' . $product['product_name'] . '.png' ?>" style="width: 400px; height: 300px; object-fit:contain;">
                        ...
                        <div class="myform">
                            ...
                            <input type="text" name="name" id="name" value="<?= $product['product_name'] ?>" style="border-radius: 8px; padding: 16px; border: 1px #E1E1E1 solid; outline: none" placeholder="Name of product" required>
                        </div>
                        <div class="myform">
                            ...
                            <div id="product-category" class="product-category" style="display: flex; align-items: center; justify-content: center; width: 100%; gap: 8px;">
                                ...
                                foreach ($data_category as $index => $category) : ?>
                                    <input type="radio" name="category_id" id="<?= ($index + 1) ?>" value="<?= ($index + 1) ?>" class="category-option" <?= ($index + 1 == $product['category_id'] ? 'checked' : '') ?>>
                        ...
                        <div class="myform">
                            ...
                            <input type="text" name="desc" id="desc" value="<?= $product['description'] ?>" style="border-radius: 8px; padding: 16px; border: 1px #E1E1E1 solid; " placeholder="Ex. “Isi ayam suwir”">
                        </div>
                        <div class="myform">
                            <label for="stock">Stock(s)<span style="color: #EC1A1A;">*</span></label>
                            <input type="number" name="stock" id="stock" min="1" value="<?= $product['stocks'] ?>" style="border-radius: 8px; padding: 16px; border: 1px #E1E1E1 solid; " placeholder="0" required>
                        </div>
                        <div class="myform">
                            <label for="bprice">Buying Price<span style="color: #EC1A1A;">*</span></label>
                            <div class="input-box">
                                IDR
                                <input type="number" name="bprice" id="bprice" value="<?= $product['buying_price'] ?>" style="width: 100%; border: none; outline: none;" placeholder="000" required>
                            </div>
                        </div>
                        <div class="myform">
                            ...
                            <div class="input-box">
                                IDR
                                <input type="number" name="sprice" id="sprice" value="<?= $product['selling_price'] ?>" style="width: 100%; border: none; outline: none;" placeholder="000" required>
                            </div>
                        </div>
                    </div>
                </div>
