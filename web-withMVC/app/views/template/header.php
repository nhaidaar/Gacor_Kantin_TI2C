...
<body>
    <div class="sidebar">
        ...
        <ul>
            <li>
                <a href="<?= BASEURL . 'dashboard' ?>" <?= $data['page'] == 'dashboard' ? 'class="active"' : ''; ?>>
            ...
            <li>
                <a href="<?= BASEURL . 'product' ?>" <?= $data['page'] == 'product' ? 'class="active"' : ''; ?>>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
            ...
            <li>
                <a href="<?= BASEURL . 'transaction' ?>" <?= $data['page'] == 'transaction' ? 'class="active"' : ''; ?>>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
            ...
            <li>
                <a href="<?= BASEURL . 'notification' ?>" <?= $data['page'] == 'notification' ? 'class="active"' : ''; ?>>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
                    ...
                    ?>
                        <div class="notif"><?= $data['count_pending'] ?></div>
                    <?php
                    }
                    ?>
                </a>
