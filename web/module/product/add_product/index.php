<div class="content">
    ...
    <div class="container">
        ...
        <div style="border: 1px #EBEBEB solid; border-radius: 16px;">
            <div class="modal-header2" style="display: flex;
width: 100%;
padding: 16px;
            ...
            <form action="" method="post">
                <div class="modal-content">
                    <div style="display: flex; flex-direction: column; gap: 24px;">
                        <label for="input-file" id="drop-area" style="padding: 40px; text-align:center; border-radius: 12px; display:flex; flex-direction:column; gap: 16px; align-items:center; border: 2px #EBEBEB dashed;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 8px;">
                            ...
                            <input type="text" name="name" id="name" style="border-radius: 8px; padding: 16px; border: 1px #E1E1E1 solid;" placeholder="Name of product">
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 8px;">
                            <label for="name">Description</label>
                            <input type="text" name="name" id="name" style="border-radius: 8px; padding: 16px; border: 1px #E1E1E1 solid;" placeholder="Ex. “Isi ayam suwir”">
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 8px;">
                            <label for="name">Selling Price</label>
                            <div class="input-box" style="display: flex; align-items: center; border-radius: 8px; padding: 16px; border: 1px #E1E1E1 solid; gap: 4px;">
                                IDR
                                <input type="number" name="name" id="name" style="width: 100%; border: none; outline: none;" placeholder="000">
                            </div>
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 8px;">
                            <label for="name">Selling Price</label>
                ...
                <div class="modal-footer" style="display: flex; gap: 16px;">
                    ...
                    <div class="request-stock" style="padding: 16px; background-color: #FFC300;"><?= $_SESSION['level'] == 'admin' ? 'Add Product' : 'Request Product' ?></div>
                </div>
            </form>
        </div>
