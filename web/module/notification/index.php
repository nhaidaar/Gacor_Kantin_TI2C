...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li>
                <a href="index.php?page=notification" class="active">
                    <svg class="inactive-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
    ...
    <div class="content">
        ...
        <div class="container">
            ...
            ?>
                <div class="notif-box">
                    <div class="message-box">
                        <div class="message"><span class="user-name">Naufal Haidar</span> request new product</div>
                        <div class="message-date">Tue, 28 November 2023</div>
                    </div>
            ...
            <?php } else { ?>
                <div class="notif-box">
                    <div class="message-box">
                        <div class="message user-name">Your request has been approved</div>
                        <div class="message-date">Tue, 28 November 2023</div>
                    </div>
                </div>
            <?php } ?>
